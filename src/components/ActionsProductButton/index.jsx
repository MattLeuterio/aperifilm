		...
		switch (type) {
			case "favorite":
				return (<FormattedMessage 
					defaultMessagetext={
					user 
					? isAlreadyOnTheList(type, product?.id) 
					? "actionBtnFavoriteTooltipLoggedRemove"
					: "actionBtnFavoriteTooltipLoggedAdd" 
					: "actionBtnFavoriteTooltip"
				} 
					id={
						user 
						? isAlreadyOnTheList(type, product?.id) 
			...
			case "watch":
				return (<FormattedMessage 
					...
					user 
					? isAlreadyOnTheList(type, product?.id) 
					? "actionBtnWatchTooltipLoggedRemove"
					: "actionBtnWatchTooltipLoggedAdd" 
					: "actionBtnWatchTooltip"
				} 
					id={
						user 
						? isAlreadyOnTheList(type, product?.id) 
			...
			case "vote":
				return (<FormattedMessage 
					...
					user 
					? isAlreadyOnTheList(type, product?.id) 
					? "actionBtnVoteTooltipLoggedRemove"
					: "actionBtnVoteTooltipLoggedAdd" 
					: "actionBtnVoteTooltip"
				} 
					id={
						user 
						? isAlreadyOnTheList(type, product?.id) 
