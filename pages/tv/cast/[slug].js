...
export default function ProductDetailsTv({creditsDetails, productDetails, productTypeContext, query}) {
  ...
  return (
    <ProductDetailsContainer>
      <Head>
        <title>Credits {productDetailsState?.name}  | Aperifilm</title>
      ...
      <TitlePage primaryTitle="pageTitleCredits" title={productDetailsState?.name} hasBackButton />
